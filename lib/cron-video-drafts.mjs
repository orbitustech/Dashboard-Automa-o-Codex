...
function slotConfig(slot) {
  ...
  return {
    label: "14h",
    titleLabel: "tarde",
      angle: "video curto de pausa no dia: mostrar que alguns minutos podem virar Coins dentro das regras do site",
      screenText: "Responda e junte Coins"
  };
}
...
function generationInput(site, slot, recent) {
  ...
  return {
    ...
    prompt: [
      ...
      "Explicar de forma rasa: responder pesquisas, acumular Coins e resgatar gift cards do catalogo permitido.",
    ...
    improvementPrompt: "Video vertical 9:16, Pesquisa Premios brand palette, pessoa brasileira quando fizer sentido, app de pesquisas, Coins como pontos internos em texto/progresso, gift cards Netflix/iFood/Spotify em texto simples, sem qualquer moeda, sem icone de moeda, sem dinheiro, Pix, recargas, apostas ou logos oficiais.",
    image_prompt: "Criar roteiro/prompt de video 9:16 premium para social, com cenas curtas de pesquisa no celular, saldo de Coins como pontos internos em texto/progresso e gift cards permitidos. Nao incluir moedas ou icones de moeda.",
...
function videoPrompt(generated, input, config) {
  return [
    ...
    "Cena 2: interface limpa mostra progresso/checklist e Coins como pontos internos em texto/progresso, nao dinheiro.",
    ...
    "Evitar: qualquer moeda, icone de moeda, fichas, tokens circulares, moedas fisicas, dinheiro, Pix, recarga, aposta, logos oficiais, maos deformadas, texto pequeno demais e promessa de premio certo.",
