...
const COPY_ANGLES = [
  ...
  "catalogo: destacar que Coins podem ser usados para resgatar gift cards permitidos no catalogo",
  "clareza: explicar em linguagem simples que Coins sao pontos internos, nao dinheiro",
...
const IMAGE_SCENES = [
  "lifestyle at home: person relaxed on sofa or desk, phone showing Coins progress and one reward card",
  ...
  "step-by-step visual: three compact panels showing responder pesquisa, acumular Coins, resgatar premio",
  ...
  "split composition: left side person using phone, right side clean app UI with Coins balance and reward cards",
...
const IMAGE_HEADLINES = [
  "Coins viram premios",
  "Responda e acumule Coins",
  "Comece pelo link na bio",
  "Pesquisas que valem pontos",
  "Seu tempo pode virar Coins",
  "Resgate gift cards",
  "Pontos para premios",
...
export async function generateSocialPost(input) {
  ...
  const prompt = [
    "Voce e um estrategista senior de social media para um site de pesquisas com Coins.",
    ...
    "Estrutura obrigatoria da legenda: 1) gancho diferente dos posts recentes; 2) explicacao rasa e simples do fluxo responder pesquisas -> acumular Coins -> resgatar gift cards do catalogo permitido; 3) CTA para clicar/acessar o link da bio.",
    ...
    "Explique Coins como pontos internos usados para resgatar gift cards do catalogo permitido, nunca como dinheiro.",
    ...
    "O prompt de imagem deve ser, por padrao, uma ilustracao 3D premium vertical 9:16 com elementos do Pesquisa Premios, Coins como pontos internos, gift cards/categorias e uma frase curta grande e legivel.",
    `A imagem deve seguir a paleta visual do Pesquisa Premios: ${PESQUISA_PREMIOS_PALETTE}.`,
    "Nao use moedas de nenhum tipo, icones de moeda, moedas douradas, fichas, tokens circulares, dinheiro, notas, cifroes, carteira, barras de ouro, Pix, recarga, aposta ou qualquer visual que pareca ganho financeiro.",
...
export function buildImagePrompt(input) {
  ...
  return [
    ...
    "Hard avoid list: any coin imagery, physical coins, golden coins, coin icons, round currency tokens, money, banknotes, dollar signs, currency symbols, wallets, gold bars, Pix, recharge phone cards, betting elements, real brand logos, copyrighted characters, tiny unreadable interface text, fake app names, distorted hands, uncanny faces, extra fingers, cheap stock-photo look, low quality artifacts.",
