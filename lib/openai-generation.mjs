...
const DEFAULT_IMAGE_STYLE = "premium clean 3D editorial illustration with one Brazilian adult and large headline text, no real brands";
...
export async function generateSocialPost(input) {
  const prompt = [
    ...
    "O prompt de imagem deve ser, por padrao, uma ilustracao 3D premium vertical 9:16 com uma pessoa brasileira adulta, smartphone, Koins e uma frase curta grande e legivel.",
...
export function buildImagePrompt(input) {
  ...
  return [
    ...
    "Primary composition: one adult person in a calm trustworthy pose using or holding a smartphone, with generic K coins, generic reward cards, clean premium layout, and clear social-media ad structure.",
    ...
    "Hard avoid list: real brand logos, copyrighted characters, tiny unreadable interface text, fake app names, distorted hands, uncanny faces, extra fingers, cheap stock-photo look, low quality artifacts.",
